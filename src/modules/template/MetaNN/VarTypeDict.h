#ifndef VARTYPEDICT_H
#define VARTYPEDICT_H
...
template <size_t Pos, typename ...TTages>
struct Pos2Type_
{
    static_assert((Pos != 0), "Invalid position.");
};

template <size_t Pos, typename TCur, typename ...TTages>
struct Pos2Type_<Pos, TCur, TTages ...>
{
    using type = typename std::conditional_t<(Pos == 0), 
                                             Identity_<TCur>, 
                                             Pos2Type_<Pos-1, TTages...>>::type;
};

template <size_t Pos, typename ...TTages>
using Pos2Type = typename Pos2Type_<Pos, TTages ...>::type;
